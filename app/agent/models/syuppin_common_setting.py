...
class SyuppinCommonSetting(Base):
    __tablename__ = 't_syuppin_common_setting'
    mysql_charset = 'utf8mb4',
    mysql_collate = 'utf8mb4_unicode_ci'

    id = Column('id', Integer, primary_key=True)
    account_id = Column('account_id', String(100), nullable=False)
    sec_no = Column('sec_no', Integer, nullable=False, default=0)
    column_id = Column('column_id', String(64), nullable=False)
    column_name = Column('column_name', String(64), nullable=False)
    column_value = Column('column_value', String(128), nullable=True, default=None)
